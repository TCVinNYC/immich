...
export const openFileUploadDialog = (uploadType) => {
    try {
        ...
        fileSelector.onchange = async (e) => {
          ...
          Please use the CLI tool if you need to upload more than 50 files.`,
            ...
            const acceptedFile = files.filter((e) => e.type.split('/')[0] === 'video' || e.type.split('/')[0] === 'image');
...
async function fileUploader(asset, uploadType) {
